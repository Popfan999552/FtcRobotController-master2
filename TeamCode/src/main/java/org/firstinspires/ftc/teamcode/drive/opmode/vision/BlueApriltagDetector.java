...
public class BlueApriltagDetector extends LinearOpMode {
    OpenCvCamera camera;
    ...
    public AprilTagDetection setTagOfInterest(String color, BlueSleeveDetection.ParkingPosition pixelpos) {

        if(pixelpos==BlueSleeveDetection.ParkingPosition.RIGHT && color == "blue") {
            ID_TAG_OF_INTEREST=1;

        } else if (pixelpos==BlueSleeveDetection.ParkingPosition.CENTER && color == "blue"){
            ID_TAG_OF_INTEREST=2;
        } else{
            ID_TAG_OF_INTEREST=3;

        }
        if(pixelpos==BlueSleeveDetection.ParkingPosition.RIGHT && color == "red") {
            ID_TAG_OF_INTEREST=4;
        } else if (pixelpos==BlueSleeveDetection.ParkingPosition.CENTER && color == "red"){
