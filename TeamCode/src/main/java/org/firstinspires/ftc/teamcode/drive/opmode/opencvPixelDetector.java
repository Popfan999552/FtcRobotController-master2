...
public class opencvPixelDetector extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        camera.openCameraDevice();//open camera
        camera.setPipeline(new StageSwitchingPipeline());//different stages
        camera.startStreaming(rows, cols, OpenCvCameraRotation.UPRIGHT);//display on RC
        //width, height
        ...
        while (opModeIsActive()) {
            ...
            if(valLeft<255){
                telemetry.addData("woeirjwoeifj",1);
            }
            telemetry.update();
            sleep(100);
